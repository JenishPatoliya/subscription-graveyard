  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        {['Overview', 'Receipts', 'Actions'].map(t => (
          <button
            key={t}
        ...
        {tab === 'actions' && (
          <div style={{
            ...
            {sub.cancel_url && (
              <a
                ...
                style={{
                  ...
                  alignItems: 'center',
                  justifyContent: 'space-between',
                  boxShadow: '0 8px 24px rgba(255,68,85,0.3)',
                  textDecoration: 'none'
                }}
              >
                <span>Cancel {sub.service_name} →</span>
                <span style={{ fontSize: 11, opacity: 0.8 }}>
                  Save {formatCurrency(sub.amount)}/mo
                </span>
              </a>
            )}
            ...
            <div style={{
              ...
              Opens official {sub.service_name} settings page.
            ...
            <button
              ...
              disabled={updating}
              style={{
                background: sub.user_marked === 'active'
                  ? 'rgba(0,230,118,0.15)'
                  : 'rgba(255,255,255,0.04)',
                border: sub.user_marked === 'active'
                  ? '1px solid rgba(0,230,118,0.3)'
                  : '1px solid rgba(255,255,255,0.08)',
                borderRadius: 14,
                color: sub.user_marked === 'active'
                  ? '#00E676'
            ...
            <button
              ...
              disabled={updating}
              style={{
                background: sub.user_marked === 'cancelled'
                  ? 'rgba(255,68,85,0.15)'
                  : 'rgba(255,255,255,0.04)',
                border: sub.user_marked === 'cancelled'
                  ? '1px solid rgba(255,68,85,0.3)'
                  : '1px solid rgba(255,255,255,0.08)',
                borderRadius: 14,
                color: sub.user_marked === 'cancelled'
                  ? '#FF4455'
                  : 'rgba(255,255,255,0.5)',
                padding: '14px 20px',
                fontSize: 13,
            ...
            {/* Mark reviewing */}
            <button
              onClick={() => handleMarkStatus('reviewing')}
              disabled={updating}
              style={{
                background: sub.user_marked === 'reviewing'
                  ? 'rgba(255,184,0,0.15)'
                  : 'rgba(255,255,255,0.04)',
                border: sub.user_marked === 'reviewing'
                  ? '1px solid rgba(255,184,0,0.3)'
                  : '1px solid rgba(255,255,255,0.08)',
                borderRadius: 14,
                color: sub.user_marked === 'reviewing'
                  ? '#FFB800'
                  : 'rgba(255,255,255,0.5)',
                padding: '14px 20px',
                fontSize: 13,
